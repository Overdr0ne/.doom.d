...
(map! :leader
 ...
 (:prefix-map ("z" . "scratch")
  :desc "Elisp"   "l" #'(lambda () (interactive) (find-file "~/test/elisp/test.el"))
  :desc "C"       "c" #'(lambda () (interactive) (find-file "~/test/c/test.c"))
  :desc "generic" "z" #'doom/open-scratch-buffer)

	  ;;; <leader a --- admin
 (:prefix-map ("a" . "admin")
   :desc "arch packages"                 "a"   #'helm-system-packages
   :desc "emacs"                         "e"   #'counsel-package
 ...
 (:prefix-map ("l" . "lookup")
   ...
   :desc "search at point"               "l" #'+default/search-project-for-symbol-at-point
